...
foreach($query[1] as $items)
	...
	$nestedData[] = $estareg;
	$nestedData[] = "<button type='button'  data-target='#userModal' data-toggle='modal' data-backdrop='static' data-keyboard='false' onclick='cargar_form(3,".$items["idperfil"].")' class='btn btn-block btn-info'>Editar</button>";
