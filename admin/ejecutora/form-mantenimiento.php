<?php
	...
	if($cod!=0)
	{
		$query = "select * from ejecutora where idejecutora=".$cod;
...
<form method="post" enctype="multipart/form-data"  id="user_form"  name="user_form">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Mantimiento Ejecutora</h4>
				<input type="hidden" name="op" id="op" value="<?php echo $op; ?>"  />
			</div>
			<div class="modal-body">
				<label>Item</label>
				<input type="text" name="1form_idejecutora" id="codigo" class="form-control"  value="<?=$row[1]["idejecutora"]?>"  />
				<br />
				<label>Unidad Ejecutora</label>
				<input type="text" name="0form_descripcion" id="descripcion" value="<?=$row[1]["descripcion"]?>" class="form-control" />
                <label>Codigo Ejecutora</label>
                <input type="text" name="0form_codejecutora" id="codejecutora" value="<?=$row[1]["codejecutora"]?>" class="form-control" />
            <br/>
