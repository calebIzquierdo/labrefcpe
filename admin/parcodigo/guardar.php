<?php
    ...
    if($_POST["op"]==1)
    {
		...
		for($i=1;$i<=$_POST["contar_diagnostico"];$i++)
		{
			...
			$sql1 = "insert into muestra_det(idmuestradetalle,idingresomuestra,idtipo_examen, idarea, idusuario,  nombre_usuario,idareatrabajo,codbarra )
                values(".$next_detalle.",".$next.",".$_POST["idtipo_examen".$i].",".$_POST["idarea".$i].",".$_POST["0form_idusuario"].",
				'".$_POST["0form_nombre_usuario"]."',".$_POST["idareatrabajo".$i].",'".$_POST["0form_codbarra"]."')";
		echo $sql1."\n ";
