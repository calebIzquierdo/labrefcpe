	...
	class impresion extends clsreporte
	{
		...
		*/
		function contenido($nromovimiento)
		{
			...
			$query = $this->execute_select("select  idurocultivo,idtipourocultivo, fecharecepcion, codbarra, codlabref,  edadactual, fechatoma, idtipomuestra,
										fecharesultado, observaciones, coddiagnostico, idtipo, fechadigitacion, pacientes, nrodocumento,recuento,
										medico_solicita, tipmuestra, tipseguro,estado_examen,idatendido
