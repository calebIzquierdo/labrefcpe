...
<form method="post" enctype="multipart/form-data"  id="user_form"  name="user_form">
		<div class="modal-content"  >
			...
			<div class="modal-body">
				<label>Item</label>
				<input type="text" name="1form_idred" id="idred" class="form-control"  value="<?=$row[1]["idred"]?>"  />
				<br />

				<label>Ejecutora</label>
				<select id="idejecutora" name="0form_idejecutora" class="form-control combobox"  onchange="cargar_red(this.value,<?php echo $row[1]["idred"]; ?>)"> >
