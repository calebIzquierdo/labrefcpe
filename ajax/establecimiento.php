<?php
    ...
    $queryT = "select * from establecimiento where idmicrored= ".$idmicrored ." and estareg=1";
        $itemsT = $objconfig->execute_select($queryT,1);

 ?>
<select id="idestablecimiento" name="0form_idestablecimiento" class="form-control" <?php echo $onchange; ?> >
