...
$sql = "select idcliente, razonsocial, ruc, direccion,  ";
...
foreach($query[1] as $items)
	...
	$nestedData[] = "<button type='button'  data-target='#userModal' data-toggle='modal' onclick='cargar_form(2,".$items["idcliente"].")' class='btn btn-outline btn-warning btn-primary btn-xs'>Editar</button>";
