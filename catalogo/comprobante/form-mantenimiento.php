<?php
	...
	if($cod!=0)
	{
		$query = "select * from tipo_comprobante where idcomprobante=".$cod;
...
<form method="post" enctype="multipart/form-data"  id="user_form"  name="user_form">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <label>Item</label>
                <input type="text" name="1form_idcomprobante" id="codigo" value="<?=$row[1]["idcomprobante"]?>" class="form-control" />
                <br />
                ...
                <input type="text"  name="0form_abreviado" id="abreviado" value="<?=$row[1]["abreviado"]?>"  class="form-control" />
                <br />
