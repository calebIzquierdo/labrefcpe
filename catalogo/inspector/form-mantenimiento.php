...
include("../../objetos/class.conexion.php");	
	...
	if($cod!=0)
	{
		$query = "select * from inspector where idinspector=".$cod;
...
<form method="post" enctype="multipart/form-data"  id="user_form"  name="user_form">
		<div class="modal-content">
			...
			<div class="modal-body">
				<label>Item</label>
				<input type="text" name="1form_idinspector" id="codigo" value="<?=$row[1]["idinspector"]?>" class="form-control" readonly   />
				...
				<select id="idprofesion" name="0form_idprofesion" class="form-control" >
					...
					<?php
						$queryT = "select * from tipo_profesion where estareg=1";
						$itemsT = $objconfig->execute_select($queryT,1);
