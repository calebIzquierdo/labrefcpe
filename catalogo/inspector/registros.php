...
$sql = "SELECT idinspector, nombres,apellidos, nrodocumento, profesion, direccion, estareg ";
$sql.= " FROM vista_inspector WHERE 1=1";
...
foreach($query[1] as $items)
	...
	$nestedData[] = "<button type='button'  data-target='#userModal' data-toggle='modal' data-backdrop='static' data-keyboard='false' onclick='cargar_form(2,".$items["idinspector"].")' class='btn btn-outline btn-warning btn-primary btn-xs'>Editar</button>";
