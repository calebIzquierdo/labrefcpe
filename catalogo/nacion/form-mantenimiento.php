<?php
	...
	if($cod!=0)
	{
		$query = "select * from nacionalidad where idnacion=".$cod;
...
<form method="post" enctype="multipart/form-data"  id="user_form"  name="user_form">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Mantimiento de Nacionalidades </h4>
				<input type="hidden" name="op" id="op" value="<?php echo $op; ?>"  />
			</div>
			<div class="modal-body">
				<label>Item</label>
				<input type="text" name="1form_idnacion" id="codigo" value="<?=$row[1]["idnacion"]?>" class="form-control"  />
				<br />
