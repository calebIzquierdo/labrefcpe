<?php
	...
	if($cod!=0)
	{
		$query = "select * from pais where idpais=".$cod;
...
<form method="post" enctype="multipart/form-data"  id="user_form"  name="user_form">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Mantimiento de País</h4>
                <input type="hidden" name="op" id="op" value="<?php echo $op; ?>"  />
            </div>
            <div class="modal-body">

                <label>Item</label>
                <input type="text"  name="1form_idpais" id="codigo" value="<?=$row[1]["idpais"]?>"  class="form-control" />
                <br />
