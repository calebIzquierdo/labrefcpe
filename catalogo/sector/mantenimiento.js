var count=0;
var carpeta = "../catalogo/sector/";
var ajax_carpeta = "../ajax/";
...
function validar_form()
{
	if($("#codubigeo").val()=="")
	{
		alert("Digite el Codigo de Ubigeo")
		return false
	}
	var pais= $("#pais").val()
        if(pais=="0")
...
function cargar_datos_departamento(val,seleccion,opc)
{
    ...
    cargar_datos_distrito(0,0,1)
	$.ajax({
            type: "POST",
            url: ajax_carpeta+"departamento.php",
...
function cargar_datos_provincia(val,seleccion,opc)
{
	$.ajax({
            type: "POST",
            url: ajax_carpeta+"provincia.php",
            data:"iddepartamento="+val+"&seleccion="+seleccion+"&opcion="+opc,
            success: function(data) {
            	$("#div-provincia").html(data)
            }
       });
}
function cargar_datos_distrito(val,seleccion,opc)
{
	$.ajax({
            type: "POST",
            url: ajax_carpeta+"distrito.php",
            data:"idprovincia="+val+"&seleccion="+seleccion+"&opcion="+opc,
            success: function(data) {
