...
include("../../objetos/class.conexion.php");	
	...
	if($cod!=0)
	{
		$query = "select * from solicitantes where idsolicitante=".$cod;
...
<form method="post" enctype="multipart/form-data"  id="user_form"  name="user_form">
		<div class="modal-content">
			...
			<div class="modal-body">
				<label>Item</label>
				<input type="text" name="1form_idsolicitante" id="codigo" value="<?=$row[1]["idsolicitante"]?>" class="form-control" readonly   />
				...
				<input type="text"  name="0form_colmedico" id="colmedico" value="<?=$row[1]["colmedico"]?>"  class="form-control" />
				</br>
