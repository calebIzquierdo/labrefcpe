<?php
	...
	if($cod!=0)
	{
		$query = "select * from tipo_bien where idtipobien=".$cod;
...
<form method="post" enctype="multipart/form-data"  id="user_form"  name="user_form">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Mantimiento Tipo Estado</h4>
                <input type="hidden" name="op" id="op" value="<?php echo $op; ?>"  />
            </div>
            <div class="modal-body">

                <label>Codigo</label>
                <input type="text" name="1form_idtipobien" id="codigo" value="<?=$row[1]["idtipobien"]?>" class="form-control" readonly/>
                <br />
