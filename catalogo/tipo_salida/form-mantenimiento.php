<?php
	...
	if($cod!=0)
	{
		$query = "select * from tipo_salida where idtiposalida=".$cod;
...
<form method="post" enctype="multipart/form-data"  id="user_form"  name="user_form">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <label>Codigo</label>
                <input type="text" name="1form_idtiposalida" id="codigo" value="<?=$row[1]["idtiposalida"]?>" class="form-control" readonly/>
                <br />
