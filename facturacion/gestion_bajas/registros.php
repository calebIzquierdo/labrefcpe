<?php
	...
	$sql = "SELECT idrequerimiento, estareg, correlativo, fecharegistro, idtipomaterial, tipo, material, cantidad, cant_aprobada, stock FROM vista_materiales_sin_stock WHERE estareg = 4 AND stock = 0 ";
