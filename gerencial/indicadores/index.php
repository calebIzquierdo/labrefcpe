...
<div class="Titulo">
	Registro del catalogo de indicadores
</div>
...
<div id="miVentana" >
 <div id="div-titulo-ventanas">Mantenimiento del Catalogo de Indicadores</div>
	<div id="formM">
 	</div>
 <div style="padding: 10px; background-color: #F0F0F0; text-align: right; margin-top: 15px;">
