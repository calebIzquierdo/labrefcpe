// buscar_diagnostico
var carpeta = "../gerencial/indicadores/";
var aja2 =  "../ajax/";
/*
...
{
	var tipodelido= $("#dimension").val()
	if(tipodelido==0)
	{
		alert("Seleccione la Dimension")
		return false
	}
	...
	if(descripcion=="")
	{
		alert("El Comentario no puede ser NULO")
		return false
	}
	var descripcion= $("#formula").val()
	if(descripcion=="")
	{
		alert("La Formula no puede ser NULO")
		return false
	}
	var descripcion= $("#formula_texto").val()
	if(descripcion=="")
	{
		alert("La Formula en Texto no puede ser NULO")
		return false
	}
