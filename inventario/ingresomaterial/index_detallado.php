...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Registro Ingreso de Materiales</h1>
	  ...
	  <div class="modal-dialog modal-xl">
		<div class="modal-content">
		  <div class="modal-header">
			<h4 class="modal-title text-center" id="myModalLabel">NOTA DE INGRESO - LABORATORIO REFERENCIAS DE SAN MARTIN</h4> 
