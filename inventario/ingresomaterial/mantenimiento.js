...
var carpeta = "../inventario/ingresomaterial/";
var aja2 =  "../ajax/";
...
function agregar_antigrama()
{
	...
	if(count_edit){
        ...
        {
            console.log(mate+" == "+$("#idmaterial"+i).val()+marca+" == "+$("#idmarca"+i).val() );
            if(mate == $("#idmaterial"+i).val() && marca == $("#idmarca"+i).val() && lte == $("#lote"+i).val() )
            {
                
                alert("El Tipo de Material, Marca y Lote ya Fue Agregado")
                $("#idmaterial").val(0)
                $("#marca").val(0)
				$("#lotes").val("")
                return
