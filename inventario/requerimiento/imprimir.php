<?php 
	...
	class impresion extends clsreporte
	{
		 function Header(){
			...
			$this->SetXY(10,27);
			$this->Cell(190,5,utf8_decode("REQUERIMIENTO DE ALMACÉN"),0,1,'C');
		...
		function contenido($nromovimiento)
		{
			...
			$this->SetFont('Arial','',7);
                    ...
                    $this->Cell(30,5,"Reponsable de area",0,0,'L');
                    $this->Cell(5,5,":",0,0,'C');
				...
				//	$this->Cell(50,5,"Especificaciones",1,1,'C');
                    ...
                    $queryD = "select * from vista_requerimiento_detalle 
								where  idrequerimiento=".$nromovimiento;
                    ...
                    foreach($resultadoD[1] as $rowsD){
                        ...
                        $this->Cell(25,5,utf8_decode($rowsD["cant_requerido"]),0,0,'C');
						$this->SetXY($x,$y);
						$this->SetFont('Arial','B','');
						$this->MultiCell(41,5,utf8_decode("ESPECIFICACIONES TÉCNICAS: "),0,"L",false);
						$this->SetXY($x+42,$y);
						$this->SetFont('Arial','','');
						$this->MultiCell(150,5,utf8_decode($rowsD["especificaciones"]),0,"L",false);
                        //$this->Ln(3); 
						$y += 10;	
                    }
