<?php
	...
	foreach($query[1] as $items)
	{
		...
		case 1:
			...
			$nestedData[] = "<button type='button'  data-target='#userModal' data-toggle='modal' data-backdrop='static' data-keyboard='false' onclick='cargar_form(2,".$items["idrequerimiento"].")' class='btn btn-outline btn-info btn-primary btn-xs'>Atender</button>";
			$nestedData[] = '<p class="btn btn-info text-dark btn-xs">'.$items["estado"].'</p>';
			break;
		case 3:
			$nestedData[] = '<p class="btn btn-danger text-white btn-xs">'.$items["estado"].'</p>';
			$nestedData[] = '<p class="btn btn-danger text-white btn-xs">'.$items["estado"].'</p>';
			$nestedData[] = '<p class="btn btn-danger text-white btn-xs">'.$items["estado"].'</p>';
			break;
		case 4:
