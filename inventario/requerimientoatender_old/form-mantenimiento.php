                        ...
                        <div class="col-md-12">
                            <div style="height:200px;  overflow-x:hidden;" >
                                <table class="table table-striped table-bordered table-hover table-responsive" id="tbvalidarequ" name="tbvalidarequ" >
                                    ...
                                    <?php
                                        $count_enf=0;
                                      /*  $sqlF = "select rd.cantidad,coalesce(sm.cantidad,0.000) as stock,
										coalesce(rd.cant_aprobada,0) as cantaprobada, rd.idmaterial ,m.descripcion as material,rd.especificaciones
									...
									//	echo  $sqlF;
                                        ...
                                        foreach($rowF[1] as $rF)
                                        {
                                            ...
                                            <tr id='itemrequerimiento<?php echo $count_enf; ?>' name='itemrequerimiento<?php echo $count_enf; ?>' >
                                                ...
                                                <td>
                                                    <input type='hi' name='cantidad_a<?php echo $count_enf; ?>' id='cantidad_a<?php echo $count_enf; ?>' class="form-control" value='<?php echo $rF["cantaprobada"]; ?>' />                                                     
                                                </td>
                                                <td>
                                                    <input type='hidden' name='stock<?php echo $count_enf; ?>' id='stock<?php echo $count_enf; ?>' value='<?php echo $rF["stock"]; ?>' />
                                                    <button type="button" class="btn btn-sm" onclick='buscar_material(<?=$rF["idmaterial"]?>)' <p class="font-weight-bold"><?php echo $rF["stock"];?></p> 
                                                </td>
												  <td>
