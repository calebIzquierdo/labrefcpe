<?php
	...
	$objconfig = new conexion();
		...
		{
			$cant1 = $objconfig->execute_select("select cantidad as stock from stock_material where idmaterial='".$_POST["idmaterial".$i]."' and idmarca='".$_POST["idmarca".$i]."' and idmodelo='".$_POST["idmodelo".$i]."' and lote='".$_POST["lote".$i]."' ");
				
			echo "select cantidad as stock from stock_material where idmaterial=".$_POST["idmaterial".$i]." and idmarca='".$_POST["idmarca".$i]."' and idmodelo='".$_POST["idmodelo".$i]."' and lote='".$_POST["lote".$i]."' ";
				
			$new_cant = $_POST["cantidad".$i] + $cant1[1]["stock"];
				
			$actu = "update stock_material set cantidad='".$new_cant."'
					where idmaterial='".$_POST["idmaterial".$i]."' and idmarca='".$_POST["idmarca".$i]."' and idmodelo='".$_POST["idmodelo".$i]."' and lote='".$_POST["lote".$i]."' ";
			echo "Actualiza".$actu;
