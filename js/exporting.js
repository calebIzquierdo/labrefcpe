...
})(function (h)
{
	(function (f)
	{
		...
		r(h.lang, {
			/* printChart: "Print Report",
			downloadPNG: "Download PNG image",
			downloadJPEG: "Download JPEG image",
			downloadPDF: "Download PDF document",
			downloadSVG: "Download SVG vector image",
			contextButtonTitle: "Menu de Exportacion" */
			
			printChart: "Imprimir Reporte",
			downloadPNG: "Exportar Imagen PNG",
			downloadJPEG: "Exportar Imagen JPEG",
			downloadPDF: "Exportar Imagen PDF",
			downloadSVG: "Exportar Imagen Vector SVG",
			contextButtonTitle: "Menu de Exportacion"
		...
		r(A.prototype, {
			...
			exportChart: function (a, c)
			{
				...
				f.post(a.url, {
					filename: a.filename || "CuadroComparativo",
					type: a.type,
					width: a.width || 0,
					scale: a.scale,
					svg: c
