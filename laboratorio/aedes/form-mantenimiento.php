				...
				<div class="panel-body table-responsive">
						<table class="table table-striped table-hover table-active table-condensed" id="tbConsolidado" name="tbConsolidado" >
							...
							foreach($rowTC[1] as $rRC)
							{
								...
								$c1p2 = $objconfig->execute_select("select COUNT(idaedes_a) as c1positivo from aedes_muestra where idaedes=".$rRC["idaedes"]." and idfoco=1 and idzona=".$rRC["idzonainsp"]." and idaedes_a!=0 " );
								...
								$c2p2 = $objconfig->execute_select("select COUNT(idaedes_a) as c2positivo from aedes_muestra where idaedes=".$rRC["idaedes"]." and idfoco=2 and idzona=".$rRC["idzonainsp"]." and idaedes_a!=0 " );
								...
								$c3p2 = $objconfig->execute_select("select COUNT(idaedes_a) as c3positivo from aedes_muestra where idaedes=".$rRC["idaedes"]." and idfoco=3 and idzona=".$rRC["idzonainsp"]." and idaedes_a!=0 " );
								...
								$c4p2 = $objconfig->execute_select("select COUNT(idaedes_a) as c4positivo from aedes_muestra where idaedes=".$rRC["idaedes"]." and idfoco=4 and idzona=".$rRC["idzonainsp"]." and idaedes_a!=0 " );
								...
								$c5p2 = $objconfig->execute_select("select COUNT(idaedes_a) as c5positivo from aedes_muestra where idaedes=".$rRC["idaedes"]." and idfoco=5 and idzona=".$rRC["idzonainsp"]." and idaedes_a!=0 " );
								...
								$c6p2 = $objconfig->execute_select("select COUNT(idaedes_a) as c6positivo from aedes_muestra where idaedes=".$rRC["idaedes"]." and idfoco=6 and idzona=".$rRC["idzonainsp"]." and idaedes_a!=0 " );
								...
								$c7p2 = $objconfig->execute_select("select COUNT(idaedes_a) as c7positivo from aedes_muestra where idaedes=".$rRC["idaedes"]." and idfoco=7 and idzona=".$rRC["idzonainsp"]." and idaedes_a!=0 " );
								...
								$c8p2 = $objconfig->execute_select("select COUNT(idaedes_a) as c8positivo from aedes_muestra where idaedes=".$rRC["idaedes"]." and idfoco=8 and idzona=".$rRC["idzonainsp"]." and idaedes_a!=0 " );
								...
								$ttpos  = $c1p2[1]["c1positivo"]+$c2p2[1]["c2positivo"]+$c3p2[1]["c3positivo"]+$c4p2[1]["c4positivo"]+$c5p2[1]["c5positivo"]+$c6p2[1]["c6positivo"]+$c7p2[1]["c7positivo"]+$c8p2[1]["c8positivo"];
