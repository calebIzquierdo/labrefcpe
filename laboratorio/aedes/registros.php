...
*/
	...
	foreach($query[1] as $items)
		...
		if ($items["estareg"]==1){
			...
			$nestedData[] = "<button type='button' class='btn btn-outline btn-success btn-xs' onclick='excel_ficha(".$items["idaedes"].")' ><img src='../img/xls.png' alt='Exportar Excsl' width='20' height='20'></button>";
			...
			$nestedData[] = "<button class='btn btn-success center-block' data-toggle='modal' data-backdrop='static' data-keyboard='false' data-target='#impresiones' onclick='muestras(".$items["idaedes"].")'><span class='glyphicon glyphicon-print'></span> </button>";
