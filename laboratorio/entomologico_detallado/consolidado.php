<?php 
	...
	class impresion extends clsreporte
	{
		 function Header(){
            ...
            global $fechainicio,$fechafinal,$codred,$codmicrored,$codestablecimiento;
		...
		function contenido($fechainicio,$fechafinal,$codred,$codmicrored,$codestablecimiento)
		{
			...
			$queryG = "select f.iddepartamento, f.idprovincia, f.iddistrito, f.local from entomologia as f
						where  f.estareg=1 and f.fechainicio between '".$fechainicio."' and '".$fechafinal."' ".$and."
						group by f.iddepartamento, f.idprovincia, f.iddistrito,f.local   ";
		//	echo $queryG;
