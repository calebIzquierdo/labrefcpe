var count=0;
var carpeta = "../laboratorio/laboratorio/";
var aja2 = "../ajax/";
...
function recibir(id,nombre,coddiad,idred)
{
    ...
    $("#laboratorio").val(coddiad);
	$("#nombre_laboratorio").val(nombre+" - "+coddiad)
	$("#codrenae").val(nombre)
	$("#idlabmalaria").val(id)
...
function agregar_prueba()
{
    ...
    var ejecu		=   $("#idejecutora").val()
    var red			=   $("#idred").val()
    var micro		=   $("#idmicrored").val()
    var lab	=   $("#laboratorio").val()
    var codirena	=	$("#tcodrenae").val();
