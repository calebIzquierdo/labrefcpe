<?php
	...
	if($cod!=0)
	{
		$query = "select * from paramae where codparamae=".$cod;
...
<form method="post" enctype="multipart/form-data"  id="user_form"  name="user_form">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Mantimiento de Parametros de Reporte Entomológico </h4>
				<input type="hidden" name="op" id="op" value="<?php echo $op; ?>"  />
			</div>
			<div class="modal-body">
				<label>Item</label>
				<input type="text" name="1form_codparamae" id="codigo" value="<?=$row[1]["codparamae"]?>" class="form-control"  />
				<br />

				<label>Descripcion</label>
				<input type="text" name="0form_nroreporte" id="nroreporte" value="<?=$row[1]["nroreporte"]?>" class="form-control"  />
				<br />
				<label>Observaciones:</label>
				<textarea name="0form_observacion" id="observacion" class="form-control " rows="7" cols="120"><?php echo $row[1]["observacion"]; ?></textarea>
				<br />
