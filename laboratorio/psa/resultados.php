<?php
	...
	if($cod!=0)
	{
		$query = "select * from psa where idpsa=".$cod;
        ...
        $esta= "select idestablecimiento, idejecutora, idred, idmicrored,eje,red, micro, esta,codrenaes from vista_establecimiento where idestablecimiento=".$row[1]["idestablesolicita"];
        ...
        $ejejcut_orig = $rowEstable[1]["idejecutora"];
        $red_orig = $rowEstable[1]["idred"];
        $micro_orig = $rowEstable[1]["idmicrored"];
...
-->
				...
				<input type="hidden" name="0form_idtipo_examen" id="idtipo_examen" value="149"  />
				
				<h3 class="modal-title text-center">Registro de Examenes PSA</h3>
			</div>
                   ...
                   <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <div class="tab-content" id="pills-tabContent" >
                        <div class="tab-pane fade active in" id="home">
							...
							<div class="row">
								<div class="col-md-12">
									<input type="hidden" name="1form_idpsa" id="codigo" value="<?=$row[1]["idpsa"]?>"   <?php echo $readonly; ?>   class="form-control"/>
								<div class="col-md-3">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="col-md-1">
								<label for="atencion" class="control-label">Número Interno:  </label>
							</div>
							<div class="col-md-2">
					...
					<div id="div-datos" name="div-datos" class="col-md-12"> 
							...
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-3">
										<label for="atencion" class="control-label">Personal que Toma la Muestra:  </label>
									</div>

									<div class="col-md-9">
										<select id="idtomamuestra" name="0form_idtomamuestra" class="combobox form-control" >
											<option value="0"></option>
											<?php
											$queryT2 = "select idpersonal, nrodocumento, apellidos || '; ' || nombres as nompaciente, idprofesion 
											from personal where estareg=1 and not idprofesion = 0 order by nrodocumento asc";
											...
											{
												$selected="";
												if($rowT2["idpersonal"]==$row[1]["idtomamuestra"]){$selected="selected='selected'";}
												echo "<option value='".$rowT2["idpersonal"]."' ".$selected." >".strtoupper($rowT2["nrodocumento"]." / ".$rowT2["nompaciente"])."</option>";
											}
											?>
										</select>
                     ...
                     <!--       <h2>Profile Content Goes Here</h2>  -->
								...
								<div class="col-md-1">
									...
									<div class="col-md-2">
										<div class="input-group date form_date" data-date="" data-date-format="dd/mm/yyyy"  data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
											<input class="form-control" type="text" name="0form_fecharesultado" id="fecharesultado" value="<?=$row[1]["fecharesultado"]?>"   >
											<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
									...
									<div class="col-md-2">
                                        <input type="time" name="0form_hora" id="hora" value="<?=$row[1]["hora"]?>"  class="form-control" placeholder="Valor" data-toggle="tooltip" data-placement="top" title="Hora del Resultado" />
                                    </div>
									<div class="col-md-1">
										<label>Resultado:</label>
									</div>
									<div class="col-md-2">
                                        <input type="text" name="0form_valorresultado" id="valorresultado" value="<?=$row[1]["valorresultado"]?>"  class="form-control" placeholder="Valor" data-toggle="tooltip" data-placement="top" title="Resultado de Prueba" />
                                    </div>
							...
							<div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="0form_observaciones" id="observaciones" value="<?=$row[1]["observaciones"]?>"  class="form-control" placeholder="Valor" data-toggle="tooltip" data-placement="top" title="Resultado de Prueba" />
                                    </div>
                                </div>
                            </div>
							</br>
