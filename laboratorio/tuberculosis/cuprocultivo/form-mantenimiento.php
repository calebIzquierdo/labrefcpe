<?php
	...
	if($cod!=0)
	{
		$query = "select * from coprocultivo where idcoprocultivo=".$cod;
...
-->
				...
				<input type="hidden" name="idtipo_examen" id="idtipo_examen" value="37"  />
				<h3 class="modal-title text-center">Registro de Examenes Coprocultivo</h3>
			</div>
                   ...
                   <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <div class="tab-content" id="pills-tabContent" >
                        <div class="tab-pane fade active in" id="home">
							...
							<div class="row">
								<div class="col-md-12">
									<input type="hidden" name="1form_idcoprocultivo" id="codigo" value="<?=$row[1]["idcoprocultivo"]?>"   <?php echo $readonly; ?>   class="form-control"/>
								<div class="col-md-3">
						...
						<!-- <h2>Profile Content Goes Here</h2>  -->
                            ...
                            <div class="row">
								...
								<div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <select id="idtipocoprocultivo" name="0form_idtipocoprocultivo" class="form-control" onchange="tipo_resultado(this.value)"  >
                                            <option value="0"></option>
                                            <?php
                                            ...
                                            {
                                                $selected="";
                                                if($rowT["idtipourocultivo"]==$row[1]["idtipocoprocultivo"]){$selected="selected='selected'";}
									...
									<div class="col-md-1">
										<label for="atencion" class="control-label">Cod. Int</label>
									</div>
									<div class="col-md-2">
                                        <input type="text" name="0form_nroingreso" id="nroingreso" value="<?=$row[1]["nroingreso"]?>"  class="form-control" <?php // echo $readonly; ?>  placeholder="Cod. Interno" data-toggle="tooltip" data-placement="top" title="Cod. Interno" />
                                    </div>
...
<script type="text/javascript">
	...
	tipo_resultado(<?php echo $row[1]["idtipocoprocultivo"];?>)
