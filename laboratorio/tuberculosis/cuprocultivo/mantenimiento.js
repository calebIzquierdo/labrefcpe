...
var carpeta = "../laboratorio/tuberculosis/cuprocultivo/";
var aja2 =  "../../ajax/";
...
{
	var urlprint = "../laboratorio/tuberculosis/cuprocultivo/imprimir.php?nromovimiento="+nro+"&embedded=true";
...
{
	objindex="Pacientes"
	var ventana=window.open("../lista/pacientes/", 'Pacientes', 'width=1020,height=600,resizable=no, scrollbars=yes, status=yes,location=yes');
	ventana.focus();
}
...
function tipo_resultado(id)
{
	...
	if (id==2){
		...
		$.ajax({
		 ...
		 data: "cod="+idres+"&iduro="+iduro+"&rcuent="+rcuento,
         success: function(data) {
