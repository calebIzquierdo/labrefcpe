<?php
	...
	$query = "select * from coprocultivo where idcoprocultivo=".$iduro;
...
?>	
				...
				<div class="panel panel-info ">
					...
					<div class="panel-body">
						<table class="table table-striped table-bordered table-hover table-responsive" id="tbdiagnostico" name="tbdiagnostico" >
							...
							<?php
							$count_diagn=0;
							$sqlF = "select  prp.idcoprocultivo, prp.idantibiograma, prp.idtipoantibiograma, p.descripcion as antibio, 
									 td.descripcion as tipantibio
									from coprocultivo_antibiograma as prp
									...
									where prp.idcoprocultivo=".$iduro ;
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="col-md-1">
				<label for="atencion" class="control-label">Ex. Fisico:  </label>
			</div>
