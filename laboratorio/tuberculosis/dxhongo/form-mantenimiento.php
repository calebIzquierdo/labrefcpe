		...
		<div class="modal-content modal-lg">
			...
			<div class="row">
				<div class="col-md-12">
                    ...
                    <div class="col-md-2">
						<input type="text" name="0form_codlabref" id="codlabref" value="<?=$row[1]["codlabref"]?>"  class="form-control" placeholder="Código Laboratorio" data-toggle="tooltip" data-placement="top" title="Código Laboratorio" />
				...
				<label for="atencion" class="control-label">Cod. Barra</label>
                  ...
                  <div class="col-md-3">
                <input type="text" name="0form_codbarra" id="codbarra" class="form-control" value="<?php echo $row[1]["codbarra"]; ?>" placeholder="Código de Barra" data-toggle="tooltip" data-placement="top" title="Código de Barra" />
	       		</div>
