<?php
	...
	if($cod!=0)
	{
		$query = "select * from dxhongo where iddxhongo=".$cod;
...
<form method="post" enctype="multipart/form-data"  id="user_form"  name="user_form">
		<div class="modal-content modal-lg">
			...
			<div class="row">
				<div class="col-md-12">
                    <div class="col-md-1"><input type="text" name="1form_iddxhongo" id="codigo" value="<?=$row[1]["iddxhongo"]?>"   <?php echo $readonly; ?>   class="form-control"/>
                    </div>
                     ...
                     <!--       <h2>Profile Content Goes Here</h2>  -->
                            ...
                            <div class="row">
								...
								<div class="col-md-2">
									...
									<div class="col-md-3">
									  <select id="idresultado" name="0form_idresultado" class="combobox form-control"   >
											<option value=""></option>
											<?php
											$queryT = "select idresultado,descripcion 
														from tipo_resultado  where idresultado in (29, 28) and estareg=1 
														order by descripcion asc";
											$itemsT = $objconfig->execute_select($queryT,1);
											...
											{
												$selected="";
												if($rowT["idresultado"]==$row[1]["idresultado"]){$selected="selected='selected'";}
							...
							<div class="col-md-1">
                                        <label for="atencion" class="control-label"> Cultivo: </label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="text" id="cultivo" name="0form_cultivo" class="form-control " value="<?=$row[1]["cultivo"]?>"  />
                                    </div>
							...
							<div class="row">
								...
								<div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" id="etiologia" name="0form_etiologia" class="form-control " value="<?=$row[1]["etiologia"]?>"  />
                                    </div>
								...
								<div class="col-md-2">
									...
									<div class="col-md-4">
										<input class="form-control" type="text" name="0form_acaro" id="acaro" value="<?=$row[1]["acaro"];?>"   >
									</div>
                                </div>
                            </div>
                            </br>
							<div class="row">
								...
								<div class="col-md-1">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" id="exdirecto" name="0form_exdirecto" class="form-control " value="<?=$row[1]["exdirecto"]?>"  />
                                    </div>
									<div class="col-md-1">
                                        <label for="atencion" class="control-label"> Gram: </label>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="text" id="gram" name="0form_gram" class="form-control " value="<?=$row[1]["gram"]?>"  />
                                    </div>
								<div class="col-md-1">
										<label>Ziehl Neelsen:</label>
									</div>
									<div class="col-md-3">
										<input class="form-control" type="text" name="0form_ziehl" id="ziehl" value="<?=$row[1]["ziehl"];?>"   >
									</div>
