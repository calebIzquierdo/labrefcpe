<?php
	...
	if($cod!=0)
	{
		$query = "select * from secreciones where idsecreciones=".$cod;
...
-->
				...
				<h3 class="modal-title text-center">Registro de Examenes Secreciones</h3>
			</div>
                   ...
                   <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <div class="tab-content" id="pills-tabContent" >
                        <div class="tab-pane fade active in" id="home">
							...
							<div class="row">
							<div class="col-md-12">
							<input type="hidden" name="1form_idsecreciones" id="codigo" value="<?=$row[1]["idsecreciones"]?>"   <?php echo $readonly; ?>   class="form-control"/>
					...
					<div id="div-datos" name="div-datos" class="col-md-12"> 
					 ...
					 <div class="row">
						<div class="col-md-12">
							<div class="col-md-3">
								<label for="atencion" class="control-label">Interpretación Negativa:</label>
							</div>
							<div class="col-md-9">
							 <input type="text" name="0form_internegativo" id="internegativo" value="<?=$row[1]["internegativo"]?>"  class="form-control"  />
							</div>
					   ...
					   <div class="row">
						<div class="col-md-12">
							<div class="col-md-3">
								<label for="atencion" class="control-label">Interpretación Positiva:</label>
							</div>
							<div class="col-md-9">
							 <input type="text" name="0form_interpositivo" id="interpositivo" value="<?=$row[1]["interpositivo"]?>"  class="form-control"  />
							</div>
						</div>
					</div>
					  </br>
