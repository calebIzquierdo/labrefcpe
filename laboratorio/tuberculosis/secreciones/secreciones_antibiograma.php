...
?>	</br>
		...
		<div class="col-md-12">
			...
			<div class="col-md-9">
				<select id="idresultado" name="0form_idresultado" class="form-control" <?php echo $readonly; ?> >
					...
					{
						$selected="";
						if($rowT2["idresultado"]==$result){$selected="selected='selected'";}
	...
	<div class="row">
		<div class="col-md-12">
	<div class="col-md-3">
				<label for="atencion" class="control-label">Recuento Celular:</label>
				</div>
                  <div class="col-md-7">
                <input type="text" name="0form_recuento" id="recuento" class="form-control" value="<?php echo $rcuent; ?>" placeholder="Código de Barra" data-toggle="tooltip" data-placement="top" title="Código de Barra" />
	       		</div>
				<div class="col-md-2">
				<label for="atencion" class="control-label">ufc/ml</label>
				</div>
	       		</div>
	</div>
	</br>
				...
				<div class="panel panel-info ">
					...
					<div class="panel-body">
						<table class="table table-striped table-bordered table-hover table-responsive" id="tbdiagnostico" name="tbdiagnostico" >
							...
							<?php
							$count_diagn=0;
							$sqlF = "select  prp.secreciones, prp.idantibiograma, prp.idtipoantibiograma, p.descripcion as antibio, 
									 td.descripcion as tipantibio
									from urocultivo_antibiograma as prp
