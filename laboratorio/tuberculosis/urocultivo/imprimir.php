<?php 
	...
	class impresion extends clsreporte
	{
		 function Header(){
			...
			$tit2 	= "DIAGNOSTICO BACTERIOLÓGICO DE UROCULTIVO";
		...
		function contenido($nromovimiento)
		{
			...
			$query = $this->execute_select("select  idurocultivo,idtipourocultivo, fecharecepcion, codbarra, edadactual, fechatoma, idtipomuestra,
										fecharesultado, observaciones, coddiagnostico, idtipo, fechadigitacion, pacientes, nrodocumento,recuento,
										medico_solicita, tipmuestra, tipseguro,estado_examen,idatendido,nroingreso
										FROM vista_urocultivo 
										where idurocultivo=".$nromovimiento);
			...
			$this->Cell(5,5,":",0,0,'C');
			$this->Cell(70,5,strtoupper(utf8_decode("UROCULTIVO")),0,1,'L');
			...
			if ($query[1]["idtipourocultivo"]==2)
			{
				...
				$this->Cell(5,5,":",0,0,'C');
				$this->Cell(120,5,$query[1]["recuento"]." UFC/ml ",0,1,'L');
				...
				$queryD = "select u.idantibiograma, a.descripcion from urocultivo_antibiograma as u
						  ...
						  where u.idurocultivo=".$nromovimiento." and u.idtipoantibiograma=1";
				...
				$query2 = "select u.idantibiograma, a.descripcion from urocultivo_antibiograma as u
						  inner join antibiograma as a on(u.idantibiograma=a.idantibiograma)
						  where u.idurocultivo=".$nromovimiento." and u.idtipoantibiograma=2";
				...
				$query3 = "select u.idantibiograma, a.descripcion from urocultivo_antibiograma as u
						  inner join antibiograma as a on(u.idantibiograma=a.idantibiograma)
						  where u.idurocultivo=".$nromovimiento." and u.idtipoantibiograma=3";
