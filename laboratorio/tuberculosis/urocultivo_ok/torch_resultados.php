...
?>	</br>
	...
	<div class="col-md-3">
				<label for="atencion" class="control-label">Recuento Celular:</label>
                  ...
                  <div class="col-md-7">
                <input type="text" name="0form_recuento" id="recuento" class="form-control" value="<?php echo $row[1]["recuento"]; ?>" placeholder="Código de Barra" data-toggle="tooltip" data-placement="top" title="Código de Barra" />
	       		</div>
				<div class="col-md-2">
