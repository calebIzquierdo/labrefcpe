...
<html>
	...
	function enviar(id,index,idr)
	{
		window.opener.recibir(id,$("#codren"+index).val(),$("#estab"+index).val()+" / "+$("#micr"+index).val()+" / "+$("#reds"+index).val(),idr)
		window.close()
	}
...
<div class="row">
		<div class="col-lg-12">
			...
			<h1 class="page-header">Registro de Establecimientos de Salud </h1>
