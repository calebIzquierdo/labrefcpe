...
$sql = "select idestablecimiento, eje,red, micro, esta,codrenaes,ruc, idmicrored, idred  ";
$sql.= " from vista_establecimiento WHERE estareg=1";
...
foreach($query[1] as $items)
{
  $count++;
	...
	$nestedData[] = "<img src='../../img/descargas.png' style='cursor:pointer;' title='Enviar Registro' onclick='enviar(".$items["idestablecimiento"].",".$count.",".$items["idred"].")' />";
