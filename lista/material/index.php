...
<html>
	...
	function enviar(id,index)
	{
		...
		window.opener.recibir(id,$("#umedidac"+index).val()+" - "+$("#material"+index).val(),$("#tipmat"+index).val()+"|"+$("#especificaiones"+index).val(),'0')
		window.close()
	}
...
<div class="row">
		<div class="col-lg-12">
			...
			<tr>
				...
				<th>Clasificación</th>
				<th>Medida</th>
				<th>Descripcion <small class="text-danger">(stock)</small></th>
				<th>Esp. Tec.</th>
				<th>Enviar</th>
			</tr>
