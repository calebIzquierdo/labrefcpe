...
<html>
	...
	{	
		...
		//console.log("fvencimiento",$("#fvencimiento"+index).val());
		//exit();
		window.opener.recibir(id,$("#unidad"+index).val()+" - ("+$("#marca"+index).val()+" / "+$("#modelo"+index).val()+") - "+$("#matel"+index).val(),$("#stock"+index).val(),$("#fvencimiento"+index).val())
		window.close()
	}
