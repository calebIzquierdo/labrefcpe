...
<html>
	...
	{
		//window.opener.recibir(id,$("#codren"+index).val(),$("#estab"+index).val()+" / "+$("#micr"+index).val()+" / "+$("#reds"+index).val())
		window.opener.recibir(id,$("#fecharecepcion"+index).val(),$("#estab"+index).val()+" / "+$("#micr"+index).val())
		window.close()
	}
...
<div class="row">
		<div class="col-lg-12">
			...
			<h1 class="page-header">Registro de Muestras Ingresadas </h1>
