...
$sql = "SELECT idpasajero, nombres, apellidos, nrodocumento, direccion ";
$sql.= " FROM pasajero WHERE estareg=1";
...
foreach($query[1] as $items)
{
  $count++;
	...
	$nestedData[] = "<img src='../../img/descargas.png' style='cursor:pointer;' title='enviar Registro' onclick='enviar(".$items["idpasajero"].",".$count.")' />";
