...
$sql = "SELECT idpersonal, nombres, direccion,apellidos, nrodocumento ";
$sql.= " FROM personal WHERE estareg=1";
...
foreach($query[1] as $items)
{
  $count++;
	...
	$nestedData[] = "<img src='../../img/descargas.png' style='cursor:pointer;' title='enviar Registro' onclick='enviar(".$items["idpersonal"].",".$count.")' />";
