<?php
	...
	if($cod!=0)
	{
		$query = "select * from codigobarra_estable where idcodigobarra=".$cod;
...
<form method="post" enctype="multipart/form-data"  id="user_form"  name="user_form">
		<div class="modal-content modal-lg">
			...
			<!--	<h3 class="modal-title text-primary" align="center"> <?php echo $nom_estab[1]["ejec"]; ?> </h3> -->
				<h3 class="modal-title text-success" align="center"> Creacion de Correlativo Por establecimiento</h3>
				</br>
                <div class="col-md-12">
                    <div class="col-md-2">
				...
				<input type="hidden" name="1form_idcodigobarra" id="codigo" value="<?=$row[1]["idcodigobarra"]?>" />
			</div>
			...
			<div style="height:280px;  overflow-x:hidden;" >
				...
				<div class="panel panel-info ">
					<div class="panel-heading">LISTADO DE CÓDIGOS GENERADOS </div>
