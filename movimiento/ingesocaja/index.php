...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Registros de Pagos</h1>
		<div align="left"> 
            <button type="button" id="add_button" name="add_button" data-toggle="modal" data-backdrop="static" data-keyboard="false" onclick="cargar_form(1,0)" data-target="#userModal" class="btn btn-info btn-lg">Generar Cobro</button>
	  ...
	  <div class="modal-dialog modal-xl">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title text-center" id="myModalLabel">DOCUMENTO EMITIDO - LABORATORIO REFERENCIAS DE SAN MARTIN</h4> 
		  </div>
