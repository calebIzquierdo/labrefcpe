...
*/
	...
	if (PHP_SAPI == "cli")
       ...
       // Se agregan los titulos del reporte
        ...
        $consulta = "select * from codigopatrimonio_detalle where idcodigopatrimonio=".$idcodigo;
		...
		{ 
            $n++;
			 ...
			 where idestablecimiento=(select idestablesolicita from codigopatrimonio_estable where idcodigopatrimonio=".$fila['idcodigopatrimonio']." )");
		
            //Se agregan los datos de los alumnos
            $objPHPExcel->setActiveSheetIndex(0)
				->setCellValue('A'.$i, $n)
				->setCellValueExplicit('B'.$i, strtoupper($fila['codigopatrimonio']),PHPExcel_Cell_DataType::TYPE_STRING )
