...
var carpeta = "../patrimonio/generar/";
var aja2 =  "../ajax/";
...
function buscar_establecimiento()
{
    ...
    var ventana=window.open("../lista/codestable_patrimonio/", 'Establecimiento', 'width=980,height=600,resizable=no, scrollbars=yes, status=yes,location=yes');
    ventana.focus();
}
...
function generar_codigo(){
	...
	for( var i=1;i<=$("#cantidad").val();i++)
    {
		...
		"<td align='center'>"+count_enf+"</td>"+
      	"<td>"+
		"<input type='hidden' name='codigopatrimonio"+count_enf+"' id='codigopatrimonio"+count_enf+"' value='"+codBarra+"' />"+codBarra+" </td>"+
         "</tr>")
	}
