...
//echo json_encode($_SESSION);
	...
	$sql = " select IC.idinventario, IC.nroinventario, IC.fechainventario ,MR.descripcion as microred, E.descripcion as ejecutora, R.descripcion as red,ES.descripcion as establecimiento,U.nombres as usuario";
	...
	foreach($query[1] as $items)
		...
		$nestedData[] = "<button type='button'  data-target='#userModal' data-toggle='modal' data-backdrop='static' data-keyboard='false' onclick='cargar_form_bienes(1,".$items["idinventario"].")' class='btn btn-outline btn-success btn-primary btn-xs'>Agregar Bienes</button>";
     	$nestedData[] = "		 
		<button type='button'  data-target='#userModal' data-toggle='modal' data-backdrop='static' data-keyboard='false' onclick='cargar_form(2,".$items["idinventario"].")' class='btn btn-outline btn-warning btn-primary btn-xs'>Editar</button>";
		//<button type='button'  data-target='#userModal' data-toggle='modal' data-backdrop='static' data-keyboard='false' onclick='anular_form(3,".$items["idinventario"].")' class='btn btn-outline btn-danger btn-primary btn-xs'>Anular</button>
		$nestedData[] = $items["usuario"];
