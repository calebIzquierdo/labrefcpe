...
*/
    ...
    $cuenta = $objconfig->execute_select($consulta1 );
   	...
   	if($cuenta[1]["total"] > 0 ){
		...
		$titulosColumnas = array("Nro","Fecha Ingreso","Codigo Barra","Procedencia","Tipo Atención","Tipo Exámen","Unidad de Trabajo",
								 "Distrito","Provincia","Departamento","Micro Red","Red","Ejecutora","Comprobante","N° Comprobante","A Nombre de:","Tipo Documento","N° Documento","Fecha Emisión","Tipo Pago","Precio","Descuento", "Total Pagar");
       ...
       // Se agregan los titulos del reporte
		...
		$objPHPExcel->getActiveSheet()->getStyle('A3:W3')->applyFromArray($estiloTituloReporte);
		$objPHPExcel->getActiveSheet()->getStyle('A4:W4')->applyFromArray($estiloTituloReporte);
		$objPHPExcel->getActiveSheet()->getStyle('A6:W6')->applyFromArray($estiloTituloColumnas);
		$objPHPExcel->getActiveSheet()->setSharedStyle($estiloInformacion, 'A7:V'.($i-1));
